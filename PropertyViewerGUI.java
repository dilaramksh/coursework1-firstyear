...
public class PropertyViewerGUI
{
    ...
    /**
     * Called when the 'Toggle Statistics' button was clicked.
     */
    private void toggleStatisticsButton()
    {
        viewer.toggleStats();
    }
    ...
    private void makeFrame()
    {
        ...
        statisticsButton.addActionListener(new ActionListener() {
                               public void actionPerformed(ActionEvent e) { toggleStatisticsButton(); }
                           });
